...
using System.Text;
using Wpf.Ui.Markdown.Renderers.Xaml;
using Wpf.Ui.Markdown.Renderers.Xaml.Inlines;
...
public class XamlRenderer : TextRendererBase<XamlRenderer>
{
    ...
    public override object Render(MarkdownObject markdownObject)
    {
        ...
        if (markdownObject is MarkdownDocument)
        {
            ...
            Write(" xmlns:markdig=\"clr-namespace:Wpf.Ui.Markdown;assembly=Wpf.Ui.Markdown\"");
